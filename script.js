// Tags Implementation
const wrapper_tags_include = document.querySelector('.wrapper-tags, #include');
const wrapper_tags_exclude = document.querySelector('.wrapper-tags, #exclude');
const tags_length = document.querySelector('.tags-length');

//let tags_list_include = [];
let tags_list_exclude = [];
